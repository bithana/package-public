...
it('should throw right type', function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        expect(function () { throw new index_2.Invalid_state('yo'); }).toThrow(index_2.Invalid_state);
        return [2 /*return*/];
    });
}); });
